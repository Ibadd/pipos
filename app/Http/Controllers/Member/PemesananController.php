...
use App\Http\Resources\Pemesanan\PemesananResource;
...
class PemesananController extends Controller
{
    ...
    {
        $this->middleware('permission:PEMESANAN_READ')->only('index');
    }
    ...
    {
        try {
            $pemesanan = Pemesanan::where('uuid', $uuid)->firstOrFail();
