            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data" id="my-form">
                            @csrf
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Barang\BarangCreateRequest', '#my-form') !!}
@endsection
